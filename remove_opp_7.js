...
// Fix locationStr condition safely
...
content = content.replace(/if \(locationStr === '本館' \|\| locationStr === '對面館'\) \{[\s\S]*?let oppSim = validateGlobalCapacity[\s\S]*?\}\n\s*\}/g, '');
