// ==============================================================================
// PHIÊN BẢN V81 - STABLE CORE (V75) + ADVANCED BOOKING FLOW (6 STEPS)
// ==============================================================================
        ...
        if (rows && rows.length > 1) {
            ...
            for (let i = 1; i < rows.length; i++) {
                ...
                if (staffName && staffName.trim() !== '') {
                    ...
                    if (rows[i][1]) { const g = rows[i][1].trim().toUpperCase(); if (g==='女'||g==='F'||g==='FEMALE') gender = 'F'; }
...
// ==============================================================================
// 3. LOGIC AVAILABILITY (CÓ LỌC GIỚI TÍNH)
// ==============================================================================
...
function generateTimeBubbles(selectedDate, serviceCode, specificStaffIds = null, pax = 1, requireFemale = false, requireMale = false) {
    ...
    // Phân buổi Sáng/Chiều/Tối/Khuya
...
async function handleEvent(event) {
  ...
  // 5. Chọn Giờ hoặc Chọn Thợ (Staff/Time)
  if (text.startsWith('Pax:')) {
      ...
      // Nếu là Chỉ định số (Specific) -> Hiện Carousel chọn thợ
  ...
  // Handle Specific Staff Carousel (Vòng lặp chọn nhiều thợ)
...
app.listen(port, () => {
    console.log(`Bot V81 (Stable Core + Advanced Flow) running on ${port}`);
});