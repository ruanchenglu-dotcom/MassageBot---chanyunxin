...
// CẬP NHẬT GIÁ MỚI (THEO YÊU CẦU)
const SERVICES = {
    'CB_190': { name: '👑 帝王套餐: 腳+身 (190分)', duration: 190, type: 'BED', category: 'COMBO', price: 2000 },
    'CB_130': { name: '💎 豪華套餐: 腳+身 (130分)', duration: 130, type: 'BED', category: 'COMBO', price: 1500 },
    'CB_100': { name: '🔥 招牌套餐: 腳+身 (100分)', duration: 100, type: 'BED', category: 'COMBO', price: 999 },
    'CB_70':  { name: '⚡ 精選套餐: 腳+身 (70分)',  duration: 70,  type: 'BED', category: 'COMBO', price: 900 },
...
app.listen(port, () => {
    console.log(`Bot v44.0 (PRICE UPDATE + FULL FIX) running on ${port}`);
});