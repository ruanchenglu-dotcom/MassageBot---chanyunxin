...
async function handleEvent(event) {
  ...
  if (userState[userId] && userState[userId].step === 'PHONE') { 
      ...
      await client.replyMessage(event.replyToken, {
          ...
          contents: {
            "type": "bubble",
            "hero": { "type": "image", "url": "https://images.unsplash.com/photo-1600334089648-b0d9d302427f?q=80&w=1000", "size": "full", "aspectRatio": "20:13", "aspectMode": "cover", "action": { "type": "uri", "uri": "https://www.google.com/maps/search/?api=1&query=新北市中和區中和路163號" } },
            "body": {
...
app.listen(port, () => {
    console.log(`Bot v53.1 (FIXED MAPS + CONTACT) running on ${port}`);
});