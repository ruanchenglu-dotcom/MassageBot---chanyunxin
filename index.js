...
async function handleEvent(event) {
  ...
  if (userState[userId] && userState[userId].step === 'PHONE') { 
      ...
      // FLEX MESSAGE E-TICKET (FIXED SPACER BUG)
      const bodyContents = [
  ...
  // (Phần còn lại MyBooking, Late, Cancel, Keep, Reset... giữ nguyên như cũ)
...
app.listen(port, () => {
    console.log(`Bot v50.1 (FINAL HOTFIX - MISSING FUNCTIONS) running on ${port}`);
});