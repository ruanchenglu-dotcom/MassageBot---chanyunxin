...
const SERVICES = {
    'CB_190': { name: '👑 帝王套餐: 腳+身 (190分)', price: 2500, duration: 190, type: 'BED', category: 'COMBO' },
    'CB_130': { name: '💎 豪華套餐: 腳+身 (130分)', price: 1800, duration: 130, type: 'BED', category: 'COMBO' },
    'CB_100': { name: '🔥 招牌套餐: 腳+身 (100分)', price: 1300, duration: 100, type: 'BED', category: 'COMBO' },
    'CB_70':  { name: '⚡ 精選套餐: 腳+身 (70分)',  price: 1000, duration: 70,  type: 'BED', category: 'COMBO' },
    'FT_120': { name: '👣 足底按摩 (120分)', price: 1600, duration: 120, type: 'CHAIR', category: 'FOOT' },
    'FT_90':  { name: '👣 足底按摩 (90分)',  price: 1200, duration: 90,  type: 'CHAIR', category: 'FOOT' },
    'FT_70':  { name: '👣 足底按摩 (70分)',  price: 900, duration: 70,  type: 'CHAIR', category: 'FOOT' },
    'FT_40':  { name: '👣 足底按摩 (40分)',  price: 600, duration: 40,  type: 'CHAIR', category: 'FOOT' },
    'BD_120': { name: '🛏️ 全身指壓 (120分)', price: 1800, duration: 120, type: 'BED', category: 'BODY' },
    'BD_90':  { name: '🛏️ 全身指壓 (90分)',  price: 1350, duration: 90,  type: 'BED', category: 'BODY' },
    'BD_70':  { name: '🛏️ 全身指壓 (70分)',  price: 1000, duration: 70,  type: 'BED', category: 'BODY' },
    'BD_35':  { name: '🛏️ 半身指壓 (35分)',  price: 500, duration: 35,  type: 'BED', category: 'BODY' },
...
// --- HÀM ĐỒNG BỘ DỮ LIỆU (ĐÃ ĐỔI TÊN THÀNH syncData) ---
...
function checkAvailability(dateStr, timeStr, serviceDuration, serviceType, specificStaffId = null, pax = 1, requireFemale = false) {
    ...
    if (specificStaffId) {
        const idsToCheck = Array.isArray(specificStaffId) ? specificStaffId : [specificStaffId];
        for (const id of idsToCheck) {
            if (staffOffToday.some(s => s.staffId === id)) return false;
    ...
    if (requireFemale && !specificStaffId) {
...
async function handleEvent(event) {
  ...
  if (userState[userId] && userState[userId].step === 'PHONE') { 
      ...
      await client.replyMessage(event.replyToken, {
          ...
          contents: {
            "type": "bubble",
            "hero": { "type": "image", "url": "https://images.unsplash.com/photo-1600334089648-b0d9d302427f?q=80&w=1000", "size": "full", "aspectRatio": "20:13", "aspectMode": "cover", "action": { "type": "uri", "uri": "https://maps.google.com" } },
            "body": {
              ...
              "contents": [
                ...
                { "type": "box", "layout": "vertical", "margin": "xl", "spacing": "sm", "contents": [
                    { "type": "box", "layout": "baseline", "contents": [ { "type": "text", "text": "姓名 (Tên)", "color": "#aaaaaa", "size": "sm", "flex": 2 }, { "type": "text", "text": hoTen, "wrap": true, "color": "#666666", "size": "sm", "flex": 4, "weight": "bold" } ] },
                    { "type": "box", "layout": "baseline", "contents": [ { "type": "text", "text": "電話 (SĐT)", "color": "#aaaaaa", "size": "sm", "flex": 2 }, { "type": "text", "text": sdt, "wrap": true, "color": "#666666", "size": "sm", "flex": 4 } ] },
                    { "type": "box", "layout": "baseline", "contents": [ { "type": "text", "text": "時間 (Giờ)", "color": "#aaaaaa", "size": "sm", "flex": 2 }, { "type": "text", "text": `${minguoDate} ${gio}`, "wrap": true, "color": "#E63946", "size": "lg", "flex": 4, "weight": "bold" } ] },
                    { "type": "box", "layout": "baseline", "contents": [ { "type": "text", "text": "項目 (Gói)", "color": "#aaaaaa", "size": "sm", "flex": 2 }, { "type": "text", "text": serviceName.split('(')[0], "wrap": true, "color": "#666666", "size": "sm", "flex": 4 } ] },
                    ...
                    { "type": "box", "layout": "baseline", "contents": [ { "type": "text", "text": "技師 (Thợ)", "color": "#aaaaaa", "size": "sm", "flex": 2 }, { "type": "text", "text": staffDisplay, "wrap": true, "color": "#0000ff", "size": "sm", "flex": 4, "weight": "bold" } ] },
                    currentState.isOil ? { "type": "text", "text": "⭐ 包含油推 (Dầu)", "size": "xs", "color": "#E91E63", "align": "center", "margin": "md" } : { "type": "spacer", "size": "xs" }
                ] },
                { "type": "separator", "margin": "xl" },
                { "type": "box", "layout": "horizontal", "margin": "md", "contents": [ { "type": "text", "text": "總金額 (Total):", "size": "sm", "color": "#555555" }, { "type": "text", "text": `$${totalPrice}`, "size": "lg", "color": "#E63946", "weight": "bold", "align": "right" } ] }
              ]
            },
...
app.listen(port, () => {
    console.log(`Bot v38.3 (FIXED NAME & FINAL) running on ${port}`);
});