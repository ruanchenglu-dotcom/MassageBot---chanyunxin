...
function createStaffBubbles(filterFemale = false, excludedIds = []) {
    ...
    for (let i = 0; i < list.length; i += chunkSize) {
        ...
        bubbles.push({ "type": "bubble", "body": { "type": "box", "layout": "vertical", "contents": [ { "type": "text", "text": filterFemale ? "指定女技師" : "指定技師", "weight": "bold", "align": "center", "color": "#1DB446" }, { "type": "separator", "margin": "md" }, ...rows ] } });
    }
    return bubbles;
}
...
app.listen(port, () => {
    console.log(`Bot v41.0 (FULL CHINESE) running on ${port}`);
});