...
function createStaffBubbles(filterFemale = false, excludedIds = []) {
    ...
    if (!list || list.length === 0) { return [{ "type": "bubble", "body": { "type": "box", "layout": "vertical", "contents": [{ "type": "text", "text": filterFemale ? "沒有女技師" : "沒有其他技師", "align": "center" }] } }]; }
