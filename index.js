...
async function handleEvent(event) {
  ...
  // LOGIC XỬ LÝ SỰ KIỆN LINE GIỮ NGUYÊN NHƯ CŨ
  // (Phần này chỉ gọi các hàm helper đã được cập nhật ở trên)
  ...
  // ... (Giữ nguyên các logic xử lý Admin, Booking Flow khác, vì chúng gọi các hàm helper đã được update)
