// ==============================================================================
// PHIÊN BẢN V75 - GỐC V68.1 + REAL-TIME SYNC + 15 DAYS
// ==============================================================================
...
// --- [BỔ SUNG V75] SERVER STATE (MASTER MEMORY) ---
// Đây là "bộ não" giúp đồng bộ dữ liệu giữa các máy
...
function checkAvailability(dateStr, timeStr, serviceDuration, serviceType, specificStaffIds = null, pax = 1, requireFemale = false) {
    ...
    // [BỔ SUNG V75] Logic Real-time Check
    ...
    const workingStaffs = STAFF_LIST.filter(staff => {
        ...
        // [BỔ SUNG V75] Kiểm tra xem thợ có đang bận trên Admin Web không
        if (isBookingForNow) {
    ...
    // [BỔ SUNG V75] Check Real-time Resources (Khách vãng lai chưa ghi vào sheet)
    if (isBookingForNow) {
...
// [UPDATED] Return cả Server State
...
app.listen(port, () => {
    console.log(`Bot V75 (Sync + 15Days + V68Base) running on ${port}`);
});