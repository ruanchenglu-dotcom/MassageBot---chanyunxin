...
test('Verify Preassigned Staff Auto Predict shows designated staff even when absent', async ({ page }) => {
  ...
  console.log('✅ List View successfully predicts absent designated staff without crashing.');
});
